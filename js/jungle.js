function comparejungle(jungle, jungle2)	// Gold per min , CS per min, kills, win %
{
  var goldPerMin1 = jungle[0];
  var goldPerMin2 = jungle2[0];
  var GoldWinner = goldPerMin(goldPerMin1, goldPerMin2);


  var CSPerMin1 = jungle[1];
  var CSPerMin2 = jungle2[1];
  var CSWinner = CSPerMin(CSPerMin1, CSPerMin2);


  var Kills1 = jungle[2];
  var Kills2 = jungle2[2];
