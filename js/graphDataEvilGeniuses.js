  ...
  {
    statChart.data.datasets[0].data = [385, 335, 405, 425, 262];
  ...
  {
    statChart.data.datasets[0].data = [7.9, 4.2, 8.9, 9.4, 1.4];
    statChart.data.datasets[0].backgroundColor = [
  ...
  {
    statChart.data.datasets[0].data = [3.5, 3.2, 2.9, 6.2, 4];
    statChart.data.datasets[0].backgroundColor = [
  ...
  {
    statChart.data.datasets[0].data = [66, 62, 54, 64, 60];
    statChart.data.datasets[0].backgroundColor = [
